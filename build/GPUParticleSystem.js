...
THREE.GPUParticleSystem = function(options) {
	...
	self.particleNoiseTex = self.PARTICLE_NOISE_TEXTURE || textureLoader.load("build/textures/perlin-512.png");
	self.particleNoiseTex.wrapS = self.particleNoiseTex.wrapT = THREE.RepeatWrapping;

	// sprite texture rendered for each particle
	self.particleSpriteTex = self.PARTICLE_SPRITE_TEXTURE || textureLoader.load("build/textures/particle2.png");
